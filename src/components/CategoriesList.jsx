...
export const CategoriesList = (props) => {
    ...
    const handleCategorySelection = (categoryId) => {
        props.history.push('section/' + categoryId);
    }
    return (
        <>
            <div className={classes.root}>
                <Grid container spacing={3}>
                    {Object.values(props.categoryOptions)
                        ...
                        .map((option) => {
                            ...
                            return (
                                <>
                                    <Grid key={`${option._id}_category`} item xs={4}>
                                            ...
                                            >
                                                <CardActions disableSpacing>
                                                    <IconButton 
                                                        ...
                                                        onClick={() => handleCategorySelection(option._id)}
                                                    >
